...
const checks = [
  ...
  ['الهيدر يعرض التاريخ الهجري ثم الميلادي', admin.includes("hijri+' · '+greg")],
  ['بطاقات الكتب والإعلانات تعرض الحالة دون نص زائد', !admin.includes('إظهار / إخفاء') && admin.includes("?'مفعل':'معطل'")],
  ...
  ['رسالة واتساب تتضمن بيانات الطلب وقيمة الإعلان والملاحظات', admin.includes('buildWhatsAppMessage') && admin.includes('بخصوص طلب الإعلان رقم') && admin.includes('قيمة الإعلان') && admin.includes('whatsappNotes')],
